...
int main()
{
    ...
    //displaying the face values for both dice thrown:
    if (userInput == 'R' && userInput2 == 'G')
    {
        cout << userInput << ":" << faceVal << " " << userInput2 << ":" << faceVal2;
        if (faceVal > faceVal2)
        {
            cout << ", Score: "<< scoreOut + 1 << " to "<< scoreOut2<<endl;
        }
        else
        {
            cout << ", Score: "<< scoreOut << " to "<< scoreOut2 + 1 << endl;
        }
    }
    
    // if statement for green and red combination:
    if (userInput == 'G' && userInput2 == 'R')
    {
        cout << userInput << ":" << faceVal  << " " << userInput2 << ":" << faceVal2;
        if (faceVal  > faceVal2)
        {
    ...
    // if statement for green and blue combination :
    if (userInput == 'G' && userInput2 == 'B')
    {
        cout << userInput << ":" << faceVal   << " " << userInput2 << ":" << faceVal2;
        if (faceVal  > faceVal2)
        {
    ...
    // if statement for blue and red combination :
    if (userInput == 'B' && userInput2 == 'R')
    {
        cout << userInput << ":" << faceVal << " " << userInput2 << ":" << faceVal2;
